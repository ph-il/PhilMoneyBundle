...
* This bundle is tested and is stable with Symfony 6.0 
...
For create a file like config/packages/phil_money.yml and add it there.
...
In your config.yml or config/packages/phil_money.yml, add the form fields presentations
